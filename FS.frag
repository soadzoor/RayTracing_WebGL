...
bool findClosest(in Ray ray, inout HitRec hitRec)
{
	...
	if (intersectTriangle(ray, triangles[0], hitTemp, spheresCount))
    {
        if (hitTemp.t < minT || minT < 0.0)
        {
            minT = hitTemp.t;
    ...
    if (intersectTriangle(ray, triangles[1], hitTemp, spheresCount+1))
    {
        if (hitTemp.t < minT || minT < 0.0)
        {
            minT = hitTemp.t;
...
Material getMaterial(in int i)
{
    ...
    if (i == 6) return materials[6];
    if (i == 7) return materials[7];
    if (i == 8) return materials[8];
    if (i == 9) return materials[9];
    if (i == 10) return materials[10];
    if (i == 11) return materials[11];
    if (i == 12) return materials[12];
    if (i == 13) return materials[13];
    if (i == 14) return materials[14];
    if (i == 15) return materials[15];
    if (i == 16) return materials[16];
    if (i == 17) return materials[17];
    if (i == 18) return materials[18];
    if (i == 19) return materials[19];
